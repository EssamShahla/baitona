    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 mt-1">
          ...
          <div class="col-lg-6">
            <form action="{{ route('baitona.create-contact') }}" method="post" role="form" class="php-email-form">
                @csrf
                <div class="row gy-4">
                <div class="col-lg-6 form-group">
                  <input type="text" name="name_ar" class="form-control" id="name_ar" placeholder="Your Name" required>
                </div>
                <div class="col-lg-6 form-group">
              ...
              <div class="form-group">
                <textarea class="form-control" name="message_ar" id="message_ar" rows="5" placeholder="Message" required></textarea>
              </div>
              <div class="my-3">
