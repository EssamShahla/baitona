...
@section('main-content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('common.roles')</h4>
                </div>
                <div class="card-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <div class="text-center mb-2">
                            <h1 class="mb-1">@lang('common.add') @lang('common.role')</h1>
                        </div>
                        <form id="create_form" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                            ...
                            <div class="col-6">
                                <label class="form-label" for="permission_ids">{{__('common.permissions')}}</label>
                                <div class="mb-1">
                                    <div class="position-relative"><select class="select2 form-select select2-hidden-accessible" multiple="" id="default-select-multi permission_ids" name="permission_ids[]" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal fade" id="editUser" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <div class="text-center mb-2">
                            <h1 class="mb-1">@lang('common.edit') @lang('common.role')</h1>
                        </div>
                        <form id="editUserForm" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                            ...
                            @method('PUT')
                            <div class="col-12 col-md-12">
                                <label class="form-label" for="edit_name">{{ __('common.name') }}</label>
    ...
    @section('scripts')
        ...
        <script>
            var url = '{{ url(app()->getLocale() . '/admin/roles_manager/') }}/';
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.edit_btn', function(event) {
                    ...
                    $("#edit_permission_ids").val(permissions).trigger('change');
                });

                $(document).on('click', '#create_btn', function(event) {
                    $('#create_form').attr('action', '{{ route('roles_manager.store') }}');
                });
            });
